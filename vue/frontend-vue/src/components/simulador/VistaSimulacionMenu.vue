          ...
          <div class="col">
            <div class="card shadow h-100">
              <div class="card-body text-center">
                ...
                <h5 class="card-title">Importar desde CSV</h5>
                <p class="card-text small text-muted">Envía datos de sensores desde un archivo CSV.</p>
                <router-link to="/vista-csv" class="btn btn-secondary btn-sm">Subir archivo CSV</router-link>
              </div>
            </div>
          </div>
        </div>
