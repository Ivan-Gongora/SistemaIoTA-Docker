  ...
  <div class="plataforma-layout" :class="{ 'theme-dark': isDark, 'theme-light': !isDark }">
    ...
    <div class="plataforma-contenido" :class="{ 'shifted': isSidebarOpen }">
      ...
      <div class="dashboard-grid-premium">
        ...
        <div class="grid-item-tabs" v-if="resultado && !loading">
          <div class="tabs-premium mb-4">
            ...
            <button class="tab-btn" :class="{ 'active': tabActiva === 'datos' }" @click="cambiarTab('datos')">
              <i class="bi bi-graph-up-arrow me-2"></i>Crecimiento Acumulado
            </button>
          </div>
        </div>
        ...
        <template v-if="tabActiva === 'clima' && resultado && !loading">
            ...
            <div class="chart-container-v2 shadow-lg">
              <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <span class="text-muted-contrast small">Variables ambientales que disparan o reducen el consumo eléctrico.</span>
                </div>
            ...
            <div class="chart-container-v2 shadow-lg">
              <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <span class="text-muted-contrast small">Cruce visual del gasto diario de energía frente a la temperatura exterior.</span>
                </div>
          ...
          <div class="grid-item-header">
            <div class="chart-container-v2 shadow-lg">
              <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
                <div>
                  <h5 class="fw-bold m-0 title-contrast">Evolución de Temperatura: Exterior vs Aulas</h5>
                  <span class="text-muted-contrast small">Comparativa del clima ambiente con el aislamiento térmico interno diario.</span>
                </div>
          ...
          <div class="grid-item-header">
            <div class="chart-container-v2 shadow-lg">
              <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
                <div>
                  <h5 class="fw-bold m-0 title-contrast">Evolución de Humedad: Exterior vs Aulas</h5>
                  <span class="text-muted-contrast small">Comparativa de la humedad ambiental con la mitigación hídrica interna.</span>
                </div>
        ...
        <!-- SECCIÓN FIJA DE TABLAS (SIEMPRE VISIBLE AL FINAL) -->
          ...
          <div ref="tablaDiaria" class="glass-card shadow-lg p-0 overflow-hidden">
            <div class="table-header-v2 p-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
              <div>
                ...
                <p class="text-muted-contrast small mb-0">Cruce extendido entre consumo y lecturas ambientales comparadas con el exterior.</p>
              </div>
  ...
  methods: {
    ...
    async ejecutarAuditoria() {
      ...
      try {
        ...
        // Se inyecta simulación visual de clima exterior si el endpoint aún no lo expone en este nivel
      ...
      this.instances.climaTemp.setOption({
        ...
        tooltip: { 
            ...
            formatter: (params) => {
                let html = `<div style="padding: 5px;"><b style="color:${textColor}">Día de mes: ${params[0].name}</b><br/>`;
                params.forEach(p => {
                    html += `<span style="color:${p.color}">●</span> ${p.seriesName}: <b>${p.value.toFixed(1)} °C</b><br/>`;
                });
                return html + `</div>`;
            }
        },
      ...
      this.instances.climaHum.setOption({
        ...
        tooltip: { 
            ...
            formatter: (params) => {
                let html = `<div style="padding: 5px;"><b style="color:${textColor}">Día de mes: ${params[0].name}</b><br/>`;
                params.forEach(p => {
                    html += `<span style="color:${p.color}">●</span> ${p.seriesName}: <b>${p.value.toFixed(1)} %</b><br/>`;
                });
                return html + `</div>`;
            }
        },
    ...
    renderImpactoTermico() {
      ...
      this.instances.impactoTermico.setOption({
        ...
        legend: { data: ['Demanda (kWh)', 'Temperatura Externa'], textStyle: { color: textColor }, bottom: 35 },
        dataZoom: [{ type: 'inside' }, { type: 'slider', height: 15, bottom: 10 }],
        toolbox: { 
          show: true,
