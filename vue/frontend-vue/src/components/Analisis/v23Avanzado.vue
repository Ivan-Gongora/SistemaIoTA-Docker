        ...
        const htmlString = `
            ...
            <head>
                ...
                <style>
                    ...
                    h2 { color: #3b82f6; border-bottom: 1px solid #ccc; padding-bottom: 4px; }
            ...
            <body>
                ...
                <p><strong>Dispositivos Analizados:</strong> ${this.nombreBase} (ID: ${this.idBase}) vs ${this.nombreControl} (ID: ${this.idControl})</p>
                
                <h2>1. Resumen de Impacto Global</h2>
                <ul>
                ...
                <table>
                    ...
                    <tr>
                        <td>Ocupación Efectiva Promedio</td>
                        <td>${base.porcentaje_ocupacion}%</td>
                        <td>${ctrl.porcentaje_ocupacion}%</td>
                        <td>N/A</td>
                    </tr>
                    <tr>
                        <td>Climatología Interior (Temperatura)</td>
                        <td>${base.temperatura_promedio}°C</td>
                        <td>${ctrl.temperatura_promedio}°C</td>
                        <td>${Math.abs(base.temperatura_promedio - ctrl.temperatura_promedio).toFixed(2)}°C</td>
                    </tr>
                    <tr>
                        <td>Carga Fantasma (Desperdicio)</td>
                        <td>${base.carga_fantasma_kwh} kWh</td>
                        <td>${ctrl.carga_fantasma_kwh} kWh</td>
                        <td class="resalte">Evitada</td>
                    </tr>
                </table>

                <h2>3. Metodología Aplicada</h2>
                <p><strong>Prorrateo Tarifario:</strong> El algoritmo asigna un valor ponderado a cada kWh. El cálculo integra los cargos fijos y la demanda de potencia compartida en TU centro educativo.</p>
                <p><strong>Validación Estadística:</strong> La plataforma ejecuta un análisis ANOVA. El valor p (${comp.estadistica_anova.p_valor}) descarta fluctuaciones aleatorias y garantiza que el ahorro proviene del sistema automatizado instalado.</p>
                
                <p style="margin-top: 40px; text-align: center; font-size: 9pt; color: #64748b;">Generado automáticamente por la Plataforma IoT de Eficiencia Energética.</p>
            </body>
            </html>
        `;
