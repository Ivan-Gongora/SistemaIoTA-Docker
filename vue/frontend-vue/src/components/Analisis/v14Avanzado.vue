  ...
  <div class="plataforma-layout" :class="{ 'theme-dark': isDark, 'theme-light': !isDark }">
    ...
    <div class="plataforma-contenido" :class="{ 'shifted': isSidebarOpen }">
      ...
      <div class="dashboard-grid-premium">
            ...
            <div class="chart-container-v2 shadow-lg">
              <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <span class="text-muted-contrast small">Variables que aumentan o disminuyen el consumo eléctrico.</span>
                </div>
            ...
            <div class="chart-container-v2 shadow-lg">
              <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <span class="text-muted-contrast small">Cruce visual del gasto diario frente a la temperatura exterior.</span>
                </div>
        ...
        <!-- SECCIÓN FIJA DE TABLAS DE DATOS -->
      ...
      this.instances.clima.setOption({
        ...
        series: [
          { 
            ...
            areaStyle: { color: new echarts.graphic.LinearGradient(0,0,0,1,[{offset:0,color:'rgba(245,158,11,0.2)'},{offset:1,color:'transparent'}]) },
