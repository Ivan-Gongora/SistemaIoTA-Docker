          ...
          <div ref="tablaDiaria" class="glass-card shadow-lg p-0 overflow-hidden">
            <div class="table-header-v2 p-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
              ...
              <div class="d-flex gap-2">
                <button @click="exportarImagen('tablaDiaria', 'registro_tecnico_diario')" class="btn btn-primary btn-sm fw-bold px-3 py-2 rounded-3 shadow-sm d-flex align-items-center">
                  <i class="bi bi-camera-fill me-2 fs-6"></i> Imagen
                </button>
...
export default {
  ...
  methods: {
    ...
    async exportarImagen(refName, fileName) {
      if (!window.html2canvas) {
        console.error("Librería de captura no cargada.");
        return;
      }
      try {
        ...
        console.error("Error al generar captura visual.", error);
      }
    },
      ...
      this.instances.perfil.setOption({
        ...
        toolbox: {
          ...
          feature: {
            ...
            saveAsImage: { show: true, title: 'Descargar Gráfica', pixelRatio: 2, name: 'perfil_demanda' }
          },
        ...
        series: [
          { 
            ...
            smooth: true, 
            symbolSize: 8, 
            data: this.resultado.dispositivo_base.grafica_perfil_demanda, 
            areaStyle: { color: new echarts.graphic.LinearGradient(0,0,0,1,[{offset:0,color:'rgba(239,68,68,0.2)'},{offset:1,color:'transparent'}]) },
            emphasis: { focus: 'series', label: { show: true, formatter: '{c} W', position: 'top', color: textColor, fontWeight: 'bold' } }
          },
          { 
            ...
            smooth: true, 
            symbolSize: 8, 
            data: this.resultado.dispositivo_control.grafica_perfil_demanda, 
    ...
    renderConsumoHora() {
      ...
      this.instances.consumoHora.setOption({
        ...
        toolbox: { 
          show: true,
          feature: { saveAsImage: { show: true, title: 'Descargar Gráfica', pixelRatio: 2, name: 'consumo_horario' } },
          iconStyle: { borderColor: textColor } 
        },
        ...
        series: [
          { 
            ...
            emphasis: { focus: 'series', label: { show: true, formatter: '{c} kWh', position: 'top', color: textColor, fontWeight: 'bold' } }
          },
          { 
            name: this.nombreControl, 
            type: 'bar', 
    ...
    renderTrend() {
      ...
      this.instances.trend.setOption({
        ...
        toolbox: { 
          show: true,
          feature: { saveAsImage: { show: true, title: 'Descargar Gráfica', pixelRatio: 2, name: 'tendencia_consumo' } },
          iconStyle: { borderColor: textColor } 
        },
        legend: { textStyle: { color: textColor }, bottom: 0 },
    ...
    renderClima() {
      ...
      this.instances.clima.setOption({
        ...
        toolbox: { 
          show: true,
          feature: { saveAsImage: { show: true, title: 'Descargar Gráfica', pixelRatio: 2, name: 'clima_promedio' } },
          iconStyle: { borderColor: textColor } 
        },
        ...
        series: [
          { 
            ...
            emphasis: { focus: 'series', label: { show: true, formatter: '{c} °C', position: 'top', color: textColor, fontWeight: 'bold' } }
          },
          { 
            name: 'Humedad', 
            type: 'line', 
            ...
            emphasis: { focus: 'series', label: { show: true, formatter: '{c} %', position: 'bottom', color: textColor, fontWeight: 'bold' } }
          }
        ]
      }, true);
    },
    ...
    renderCFE() {
      ...
      this.instances.cfe.setOption({
        ...
        toolbox: { 
          show: true,
          feature: { saveAsImage: { show: true, title: 'Descargar Gráfica', pixelRatio: 2, name: 'tarifas_cfe' } },
          iconStyle: { borderColor: textColor } 
        },
        series: [{
    ...
    renderGauge() {
      ...
      this.instances.gauge.setOption({
        ...
        toolbox: { 
          show: true,
          feature: { saveAsImage: { show: true, title: 'Descargar Gráfica', pixelRatio: 2, name: 'eficiencia_operativa' } },
          iconStyle: { borderColor: textColor } 
        },
        series: [
          {
