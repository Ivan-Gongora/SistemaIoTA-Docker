          ...
          <div class="chart-container-v2 shadow-lg">
            <div class="chart-header-v2 mb-3 d-flex justify-content-between align-items-start">
              <div>
                ...
                <span class="text-muted-contrast small">Consumo registrado en kWh. Identifica los picos operativos en cada lectura horaria.</span>
              </div>
              <button @click="toggleEtiqueta('perfil')" class="btn-toggle-data" :class="{ 'active': etiquetas.perfil }" title="Mostrar/Ocultar Valores Numéricos">
                <i class="bi bi-123"></i>
              </button>
            </div>
        ...
        <div class="grid-item-chart-half" v-if="resultado">
          <div class="chart-container-v2 shadow-lg">
            <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
              ...
              <button @click="toggleEtiqueta('consumoHora')" class="btn-toggle-data" :class="{ 'active': etiquetas.consumoHora }" title="Mostrar/Ocultar Valores Numéricos">
                <i class="bi bi-123"></i>
              </button>
            </div>
        ...
        <div class="grid-item-chart-half" v-if="resultado">
          <div class="chart-container-v2 shadow-lg">
            <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
              ...
              <button @click="toggleEtiqueta('clima')" class="btn-toggle-data" :class="{ 'active': etiquetas.clima }" title="Mostrar/Ocultar Valores Numéricos">
                <i class="bi bi-123"></i>
              </button>
            </div>
        ...
        <div class="grid-item-chart-main" v-if="resultado">
          <div class="chart-container-v2 shadow-lg">
            <div class="chart-header-v2 mb-4 d-flex justify-content-between align-items-start">
              ...
              <button @click="toggleEtiqueta('trend')" class="btn-toggle-data" :class="{ 'active': etiquetas.trend }" title="Mostrar/Ocultar Valores Numéricos">
                <i class="bi bi-123"></i>
              </button>
            </div>
        ...
        <div class="grid-item-chart-side" v-if="resultado">
          <div class="chart-container-v2 shadow-lg d-flex flex-column align-items-center">
            ...
            <div class="efficiency-ring-v3 w-100 position-relative mt-2" style="height: 250px; min-height: 250px;">
              ...
              <div class="ring-data position-absolute top-50 start-50 translate-middle text-center mt-3" style="pointer-events: none;">
            ...
            <div class="col-md-4">
              <div class="explain-box shadow-sm">
                ...
                <p class="small text-muted-contrast mb-0">
                  La evaluación ejecuta un análisis ANOVA. El valor probabilístico descarta fluctuaciones aleatorias. Esta validación garantiza que tu ahorro eléctrico proviene directamente del control automatizado.
                </p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="explain-box shadow-sm border-warning">
                <div class="d-flex align-items-center gap-2 mb-3">
                  ...
                  <h6 class="fw-bold m-0 title-contrast">Impacto General</h6>
                </div>
                <p class="small text-muted-contrast mb-0">
                  La plataforma cuantifica el ahorro neto cruzando la demanda diaria con la ocupación real del aula. La diferencia confirma el éxito del experimento en el recinto escolar.
                </p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="explain-box shadow-sm border-success">
                ...
                <p class="small text-muted-contrast mb-0">
                  El sistema empareja de manera precisa los días exactos de lectura de cada sensor. El alineamiento de las fechas previene alteraciones estadísticas en la evaluación.
                </p>
              </div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      instances: { perfil: null, consumoHora: null, trend: null, clima: null, gauge: null }
    };
  },
  mounted() {
