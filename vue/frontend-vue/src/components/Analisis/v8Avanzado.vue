        ...
        <div class="grid-item-chart-main" v-if="resultado">
          <div class="chart-container-v2 shadow-lg">
            <div class="chart-header-v2">
              ...
              <span class="text-muted-contrast small">Consumo registrado en kWh. Los valores se muestran fijos en los picos de demanda.</span>
            </div>
        ...
        <div class="grid-item-chart-side" v-if="resultado">
          <div class="chart-container-v2 shadow-lg d-flex flex-column align-items-center">
            ...
            <div class="efficiency-ring-v3 w-100 position-relative">
              <div ref="chartGauge" style="width: 100%; height: 260px;"></div>
          ...
          <div class="row g-4">
            ...
            <div class="col-md-4">
              <div class="explain-box shadow-sm border-warning">
                ...
                <p class="small text-muted-contrast mb-0">
                  El algoritmo asigna un valor monetario ponderado a cada kWh. Este cálculo integra los cargos fijos y la demanda compartida de TU recinto escolar.
                </p>
              </div>
            </div>
            <div class="col-md-4">
  ...
  methods: {
    ...
    async exportarTablaLarga(refName, fileName) {
      ...
      try {
        ...
        console.error("Error al generar captura visual extendida.", error);
      }
    },
      ...
      this.instances.trend.setOption({
        ...
        series: [
          ...
          { 
            ...
            data: ctrlData,
            label: { show: true, position: 'bottom', color: textColor, fontSize: 10 },
            labelLayout: { hideOverlap: true }
          }
        ]
      }, true);
      ...
      this.instances.clima.setOption({
        ...
        series: [
          { 
            ...
            label: { show: true, position: 'top', color: textColor, fontSize: 10, formatter: '{c} °C' },
            labelLayout: { hideOverlap: true }
          },
          { 
            name: 'Humedad', 
