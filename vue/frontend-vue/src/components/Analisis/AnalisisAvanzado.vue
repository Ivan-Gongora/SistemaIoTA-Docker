            ...
            try {
                ...
                const htmlString = `
                    ...
                    <body>
                        ...
                        <p>TU plataforma cuantifica los beneficios inmediatos del control automatizado.</p>
                        <ul>
                        ...
                        <ul>
                            <li>El ${this.nombreBase} alcanza una efectividad térmica deficiente por la manipulación manual de los equipos.</li>
                            <li>El ${this.nombreControl} logra un <span class="resalte">cumplimiento superior</span> gracias al algoritmo predictivo.</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>El ${this.nombreBase} mitigó el calor en <strong>${difExteriorBase}°C</strong> y registró un promedio interior de ${promBase}°C.</li>
                            <li>El ${this.nombreControl} mitigó el calor en <span class="resalte">${difExteriorCtrl}°C</span> y mantuvo un clima óptimo de ${promCtrl}°C. TU equipo automatizado enfría mejor y gasta menos energía.</li>
                        </ul>
                        <div class="img-container">
                            <img src="${imgTemp}" alt="Gráfica de Temperatura Exterior vs Interior" />
                        </div>

                        <h2>4. Análisis de Carga Fantasma (Modo de Espera)</h2>
                        <p>La carga fantasma representa el consumo eléctrico continuo cuando el aula está vacía.</p>
                        <ul>
                            <li>El ${this.nombreBase} presenta un registro de ${base.carga_fantasma_kwh} kWh al apagar el switch manualmente.</li>
                            <li>El ${this.nombreControl} utiliza ${ctrl.carga_fantasma_kwh} kWh. Este margen corresponde a la energía necesaria para mantener los sensores IoT conectados a la red. Es una cuota operativa mínima que hace posible el ahorro masivo durante el día.</li>
                        </ul>
                        <div class="img-container">
                        ...
                        <table>
                            <tr>
                                ...
                                <th>Contraste Final</th>
                            </tr>
                            <tr>
                                <td>Consumo Promedio Diario</td>
                                <td>${base.promedio_diario} kWh</td>
                                <td>${ctrl.promedio_diario} kWh</td>
                                <td class="resalte">Diferencia de ${Math.abs(base.promedio_diario - ctrl.promedio_diario).toFixed(2)} kWh</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Diferencia de ${Math.abs(base.temperatura_promedio - ctrl.temperatura_promedio).toFixed(2)}°C</td>
                            </tr>
                            <tr>
                                <td>Humedad Relativa</td>
                                <td>${base.humedad_promedio}%</td>
                                <td>${ctrl.humedad_promedio}%</td>
                                <td>Diferencia de ${Math.abs(base.humedad_promedio - ctrl.humedad_promedio).toFixed(2)}%</td>
                            </tr>
                        </table>
