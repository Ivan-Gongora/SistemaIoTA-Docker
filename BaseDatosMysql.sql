...
CREATE TABLE ultimo_valor_campo (
    ...
    ultimo_valor DECIMAL(15,6) NOT NULL,
...
-- -----------------------------------------------------------
-- Paso 13: USUARIO Y PERMISOS (Anterior Paso 11)
-- -----------------------------------------------------------

-- Eliminar usuario si ya existe
DROP USER IF EXISTS 'sistemaiot'@'localhost';

-- Crear el usuario con contrasena
...
-- Otorgar permiso para ejecutar eventos
GRANT EVENT ON sistemaiotA_db.* TO 'sistemaiot'@'localhost';
